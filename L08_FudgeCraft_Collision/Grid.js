...
(function (L08_FudgeCraft_Collision) {
    ...
    class Grid extends Map {
        ...
        constructor() {
            super();
            this.push(L08_FudgeCraft_Collision.ƒ.Vector3.ZERO(), new GridElement(new L08_FudgeCraft_Collision.Cube(L08_FudgeCraft_Collision.CUBE_TYPE.GRAY, L08_FudgeCraft_Collision.ƒ.Vector3.ZERO())));
        }
