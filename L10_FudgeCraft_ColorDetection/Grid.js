    ...
    class Grid extends Map {
        ...
        findNeighbors(_of) {
            return [-1, 1]
                .flatMap((_element) => {
                return [
                    L10_FudgeCraft_DetectCombos.grid.pull(L10_FudgeCraft_DetectCombos.f.Vector3.SUM(_of, L10_FudgeCraft_DetectCombos.f.Vector3.X(_element))),
                    L10_FudgeCraft_DetectCombos.grid.pull(L10_FudgeCraft_DetectCombos.f.Vector3.SUM(_of, L10_FudgeCraft_DetectCombos.f.Vector3.Y(_element))),
                    L10_FudgeCraft_DetectCombos.grid.pull(L10_FudgeCraft_DetectCombos.f.Vector3.SUM(_of, L10_FudgeCraft_DetectCombos.f.Vector3.Z(_element)))
                ];
            })
                .filter((_element) => {
                return _element != null;
