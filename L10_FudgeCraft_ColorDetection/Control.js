    ...
    class Control extends f.Node {
        ...
        checkCollisions(_transformation) {
            ...
            for (let cube of this.fragment.getChildren()) {
                let element = L09_FudgeCraft_ColorDetection.grid.pull(cube.mtxWorld.translation);
                if (element)
        ...
        freeze() {
            for (let cube of this.fragment.getChildren()) {
                ...
                L09_FudgeCraft_ColorDetection.grid.push(position, new L09_FudgeCraft_ColorDetection.GridElement(cube));
            }
        }
    }
    Control.transformations = Control.defineControls();
    L09_FudgeCraft_ColorDetection.Control = Control;
